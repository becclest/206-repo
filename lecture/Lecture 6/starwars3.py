...
class Droid(Character):
    """docstring for Droid."""
    def __init__(self, name='C-3PO',
                 species='Droid', eye_color= 'yellow', birth_year='112BBY',
                 json_dict=None):
        super().__init__(name, species, json_dict)
        if json_dict is not None:
            self.birth_year = json_dict['birth_year']

    def __str__(self):
        return super().__str__() + ', birth_year: ' + self.birth_year
