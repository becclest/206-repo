...
# param: list of project scores (3 * 200 points, final = 200)
...
def test():
  ...
  if convert_to_letter_grade(points3) == expected3:
    ...
    print('TEST 2.3 failed')  #TEST failed
  ...
  ## TEST 3: Project score calculations
  test_project1 = [200, 150, 100]
  expected_project_score1 = 200 + 150 + 100 #ALL PROJECTS FAILED


  test_project2 = [200, 200, 200]
  expected_project_score2 = 200 * 3       #ALL PROJECTS FAILED

  if (calculate_project_score(test_project1) == expected_project_score1):
    print ('All Projects Passed')
  else:
    print ('All Projects failed')

  if (calculate_project_score(test_project2) == expected_project_score2):
    print ('All Projects Passed')
  else:
    print ('All Projects failed')
